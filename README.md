...
```bash
git clone https://github.com/sakshigahiwad-tech/Terrafrom-loadbalencer.git
cd Terrafrom-loadbalencer
```
...
Sakshi Gahiwad Cloud & DevOps Learner

  
GitHub:
https://github.com/sakshigahiwad-tech
